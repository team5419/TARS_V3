...
public final class Constants {
  ...
  public static final class ArmTargets {
    ...
    public ArmTargets fromDegrees(double bicepDegrees, double wristDegrees) {
      ...
      // Some magic done by 6672                                ^^^^^^^^^^^^^^^^^^^^^^ Arm gear
      // ratio
    ...
    public ArmTargets fromDegrees(
        double bicepDegrees, double wristDegrees, double safeZoneDegrees) {
      this.bicepTarget = bicepDegrees * PI / 180 / (PI / 1024 / (58.286 * 3 / 36 * 20));
      // Some magic done by 6672                                ^^^^^^^^^^^^^^^^^^^^^^ Arm gear
      // ratio
      this.wristTarget = wristDegrees * PI / 180 / (PI / 1024 / (54));
  ...
  public static class ArmConstants {
    ...
    // public static final ArmTargets high = new ArmTargets(-67421.79081481483 - 2000,
    // -45004.799999999996 + 6000); // This looks bad IK but I don't have a choice
    ...
    public static final ArmTargets cubeGround =
        new ArmTargets().fromDegrees(50.5, -175, globalSafeZone);
    ...
    // public static final double WRIST_MAX_A = 48000.0; // could be up to 102400 with good enough
    // intake
    ...
    public static final double BASE_SAFETY_THRESHOLD =
        45 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    ...
    public static final double HIGH_BASE_POS_VIKES =
        -131.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_WRIST_POS_VIKES =
        -129 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    public static final double HIGH_WRIST_POS_AUTO =
        -113.5 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    // testing to get cone very close to high
    public static final double HIGH_BASE_POS_ALT_PREP =
        -134.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_BASE_POS_ALT = -122 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_WRIST_POS_ALT =
        -146.5 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);
    ...
    public static final double HIGH_BASE_POS_ALT_FTW =
        -121.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_WRIST_POS_ALT_FTW =
        -148.5 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);
    public static final double HIGH_BASE_POS_ALT_WACO =
        -118 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_WRIST_POS_ALT_WACO =
        -152 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    public static final double HIGH_BASE_POS_ALT_AUTO =
        -120.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double HIGH_WRIST_POS_ALT_AUTO =
        -152 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    public static final double INTAKE_BASE_POS_CONE =
        23.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double INTAKE_WRIST_POS_CONE =
        -155 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    public static final double INTAKE_BASE_POS_CUBE =
        45.5 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double INTAKE_WRIST_POS_CUBE =
        -175 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);

    public static final double CHUTE_BASE_POS = 15 * PI / 180 / (PI / 1024 / BASE_GEAR_RATIO);
    public static final double CHUTE_WRIST_POS = -58 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);
    ...
    public static final double FLING_INIT_WRIST_POS =
        -50 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);
    public static final double FLING_FINAL_WRIST_POS =
        70 * PI / 180 / (PI / 1024 / WRIST_GEAR_RATIO);
  }
