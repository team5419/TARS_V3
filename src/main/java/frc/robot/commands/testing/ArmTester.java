...
public class ArmTester extends CommandBase {
  ...
  public void initialize() {
    ...
    if (waypoints.length == 0) {
      ...
      // GraphStator.calculateNewMotionMagic(new Waypoint(0, 0), new Waypoint(bicep.getDouble(0),
      // wrist.getDouble(0)), arm);
      return;
    }
    ...
    for (ArmWaypoints waypoint : waypoints) {
      ...
      // GraphStator.calculateNewMotionMagic(new Waypoint(0, 0), new Waypoint(waypoint.point.bicep,
      // waypoint.point.wrist), arm);
    }
  }
