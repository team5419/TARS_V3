...
public class AutoAlignPennTester {
  ...
  public void testPIDs() {
    ...
    double newHorizontal = horizontalController.calculate(simulateTX(), 15);
  ...
  public CustomPath testDirectPath() {
    ...
    points.add(new Point(simulateHorizontalDistance(), simulateVerticalDistance(), 0));
  ...
  public void customTwo() {
    ...
    double newHorizontal = horizontalController.calculate(0.0, target.x);
    double newVertical = veritcalController.calculate(0.0, target.y);
