...
public class AutoAlign extends CommandBase {
  ...
  //     return maxTime != -1 && (timer.get() > maxTime); //|| (LimelightHelpers.getTX("") < epsilon
  // && LimelightHelpers.getTY("") < epsilon));
  //     // return  MathUtil.applyDeadband(LimelightHelpers.getTY(""), epsilon) == 0 &&
  // MathUtil.applyDeadband(LimelightHelpers.getTX(""), epsilon) == 0;
  // }
}
