...
//         rotationController.reset(swerve.estimator.getEstimatedPosition().getRotation().getRadians()); // Should probably add a velocity
...
//         double newRotation = rotationController.calculate(swerve.getPose().getRotation().getDegrees());
