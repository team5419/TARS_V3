...
public class TwoStageHighChoiced extends SequentialCommandGroup {
  public TwoStageHighChoiced(OptimizedArm arm, Intake intake, boolean isCube) {
    addCommands(
        ...
        new BicepToPosAuto(
            arm, Constants.ArmConstants.cubeHigh.bicepTarget + arm.degreesToTicksBicep(15)),
        ...
        new InstantCommand(
            () ->
                intake.setVolts(
                    isCube
                        ? Constants.IntakeConstants.OUTTAKE_VOLTS_CUBE
                        : Constants.IntakeConstants.OUTTAKE_VOLTS)),
        new WaitCommand(0.2),
        new BicepToPosAuto(
            arm, Constants.ArmConstants.cubeHigh.bicepTarget + arm.degreesToTicksBicep(15)),
