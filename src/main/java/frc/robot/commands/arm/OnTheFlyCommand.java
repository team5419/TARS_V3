...
/**
 * This class allows you to use a command that freezes configuration on construction that you would like to be deferred until initialization.  
 * @author G
 */
public class OnTheFlyCommand extends CommandBase {
    ...
    public void initialize() {
        try {
            ...
            System.err.println("[ON THE FLY COMMAND] - Issue calling the passed in callable, aborting function. Stack trace: " + e);
            this.cancel();
            return;
        }
