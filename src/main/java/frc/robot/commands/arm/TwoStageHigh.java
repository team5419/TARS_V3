...
public class TwoStageHigh extends SequentialCommandGroup {
    public TwoStageHigh(Arm arm, Intake intake) {
        addCommands(
            ...
            new BicepToPos(arm, Constants.ArmConstants.coneHigh.bicepTarget - arm.degreesToTicks(15)), // move up + past to make sure wrist doesn't hit
            ...
            new BicepToPos(arm, Constants.ArmConstants.coneHigh.bicepTarget - arm.degreesToTicks(10)), // move up + past to make sure wrist doesn't hit
